import { AlertTriangle, AppWindow, ArrowRight, Check, ChevronLeft, ChevronRight, Command, CreditCard, File, FileText, HelpCircle, Image, Instagram, Laptop, Linkedin, Loader2, Lock, LucideProps, Mail, Moon, MoreVertical, PieChartIcon, Pizza, Plus, Settings, SunMedium, Trash, User, X } from "lucide-react";
...
export const Icons = {
  logo: (props: IconProps) => (
    ...
    >
      ...
      <g filter="url(#filter1_d_0_1)">
        <rect x="4" y="30" width="50" height="50" rx="10" fill="#FFFCFC" />
        <rect
          x="8"
          y="34"
          width="42"
    ...
    >
      <g transform="translate(-40 -40)">
        ...
        <path
          ...
          transform="translate(42.016 42.03)scale(.83207)"
        ></path>
      </g>
    </svg>
  ),
  ...
  arcjet: (props: IconProps) => (
    ...
    >
      <path
        d="m78.06 50.045c11.824 3.022 21.598 5.444 41.94 9.955-20.342 4.511-30.116 6.933-41.94 9.955-3.979 1.016-7.089 4.126-8.106 8.105-3.021 11.821-5.443 21.599-9.954 41.94-4.511-20.341-6.933-30.119-9.954-41.94-1.017-3.979-4.127-7.089-8.106-8.105-11.824-3.022-21.598-5.444-41.94-9.955 20.342-4.511 30.116-6.933 41.94-9.955 3.979-1.016 7.089-4.126 8.106-8.105 3.021-11.821 5.443-21.599 9.954-41.94 4.511 20.341 6.933 30.119 9.954 41.94 1.017 3.979 4.127 7.089 8.106 8.105z"
        fill="#fff"
      />
    </svg>
  ),
